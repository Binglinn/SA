        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    ...
                    <div class="card mb-3"  >
                        <img class="card-img img-fluid" src="assets/img/<?php echo $record['lose_picture'] ?>" alt="Card image cap" id="product-detail" onerror="javascript:this.src='assets/img/no_img.jpeg'">
                    </div>
