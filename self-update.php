...
<?php
    ...
    $sql="select user_name,user_phone,user_password FROM user where user_email='$user_email' ";   
...
<body>
        ...
        <div class="container py-5">
            <div class="row text-center py-3">
                <div class="col-lg-6 m-auto">
                    <h1 class="h1"><b><font color="green">編輯個人資料</font></b></h1>
                </div>
            </div>
        </div>
    </section>

    <?php if($_GET["update"]=="user_name"){?>
    <div class="container py-5">
        <form class="col-md-9 m-auto" action="self-update2.php" method="post" >
            <input type="hidden" name="change" value="user_name">
            <div class="mb-3">
                <label><b>信箱</b></label>
                <input type="text" class="form-control mt-1" name="email" placeholder=<?php echo $user_email?> disabled>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label><b>電話</b></label>
                <input type="text" class="form-control mt-1" name="phone" placeholder=<?php echo $record["user_phone"]?> disabled>
            </div>
            <div class="mb-3">
                <label><b>密碼</b></label>
                <input type="password" class="form-control mt-1" name="password" placeholder=<?php echo $record["user_password"]?> disabled>
            </div>
    ...
    <?php }elseif($_GET["update"]=="phone"){?>
    <div class="container py-5">
        <form class="col-md-9 m-auto" action="self-update2.php" method="post" >
            <input type="hidden" name="change" value="phone">
            <div class="mb-3">
                <label><b>信箱</b></label>
                <input type="text" class="form-control mt-1" name="email" placeholder=<?php echo $user_email?> disabled>
            </div>
            <div class="mb-3">
                <label><b>使用者名稱</b></label>
                <input type="text" class="form-control mt-1" name="user_name" placeholder=<?php echo $record["user_name"]?> disabled>
            </div>
            <div class="mb-3">
                <label><b>電話</b></label>
    ...
    <?php }elseif($_GET["update"]=="password"){?>
    <div class="container py-5">
        <form class="col-md-9 m-auto" action="self-update2.php" method="post" >
            <input type="hidden" name="change" value="password">
            <input type="hidden" name="hidden_password" value="<?php echo $record["user_password"]?>">
            <div class="mb-3">
                <label><b>信箱</b></label>
                <input type="text" class="form-control mt-1" name="email" placeholder=<?php echo $user_email?> disabled>
            </div>
